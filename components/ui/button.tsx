...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-none text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "border bg-layer2 hover:bg-foreground/20",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline: "border border-fuchsia-400 text-fuchsia-400 bg-fuchsia-400/40",
        secondary:
          "bg-layer2 text-fuchsia-400 hover:bg-fuchsia-400/20 border border-fuchsia-400 cursor-pointer",
      ...
      disabled: {
        true: "hover:bg-unset opacity-50 cursor-default pointer-events-none",
      },
    },
    defaultVariants: {
      variant: "default",
